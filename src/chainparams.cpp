...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = 100000; // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
        consensus.BIP34Height = 100000;
        consensus.BIP34Hash = uint256S("50b182ccfd32f5797bfb4189dd478deddad7c5c2a90e85905749253bdd489212");
        consensus.BIP65Height = 100000; // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        consensus.BIP66Height = 100000; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1603789200; // Octover 27, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1603875600; // Octover 28, 2020

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1603789200; // Octover 27, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1603875600; // Octover 28, 2020
        ...
        vSeeds.emplace_back("seed.scootercoin.life");
        vSeeds.emplace_back("seed.bitman360.com");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1477079243, 491089, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x92321bfe1de75a0c2866da76d9ac6dce95f88c5cd98d1444a0a19eef89ab3cb5"));
//        assert(genesis.hashMerkleRoot == uint256S(""));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.scootercointools.com");
        vSeeds.emplace_back("seed-b.scootercoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1477082131, 62361, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbd2437c1e56c5f1e5b4b809da7e74877f2f84f99774ca64f47efa924ee964699"));
