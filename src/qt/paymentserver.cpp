...
const char* BIP71_MIMETYPE_PAYMENT = "application/scootercoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/scootercoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/scootercoin-paymentrequest";
#endif
