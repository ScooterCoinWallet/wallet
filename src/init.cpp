...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    RenameThread("scootercoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/scootercoin-project/scootercoin>";
    const std::string URL_WEBSITE = "<https://scootercoin.org>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("scootercoin-loadblk");
