...
1. Clone the Scootercoin Core source code:
        ...
        git clone https://github.com/scootercoin-project/scootercoin
        cd scootercoin
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/scootercoin/src
        cp scootercoind /usr/local/bin/
        cp scootercoin-cli /usr/local/bin/
...
The first time you run scootercoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/scootercoind -daemon # Starts the scootercoin daemon.
