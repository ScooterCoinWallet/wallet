...
bech32_templates = [
  ...
  ('scoot',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('scoot',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('scoot',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tscoot',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tscoot',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tscoot',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rscoot',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rscoot',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rscoot', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tscoot',  17, 32, False, False, False),
  ('rscoot',  3,  1, False, False, False),
  ('scoot',   15, 41, False, False, False),
  ('tscoot',  0, 16, False, False, False),
  ('rscoot',  0, 32, True,  False, False),
  ('scoot',   0, 16, True,  False, False),
  ('tscoot',  0, 32, False, True,  False),
  ('rscoot',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['scoot', 'tscoot', 'rscoot']:
